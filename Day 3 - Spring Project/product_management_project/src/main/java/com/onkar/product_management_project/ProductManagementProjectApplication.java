...
public class ProductManagementProjectApplication {
 	...
 	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(ProductManagementProjectApplication.class, args);
		
		ProductService service = context.getBean(ProductService.class);

        service.getAllProducts().stream().forEach(p -> System.out.println(p));
